...
public class MemberViewController {
	...
	public String medicalRecordList(
		...
		List<ResponseMedicalHistoryDto> myMedicalRecords = appointmentService.getMyMedicalRecords(
	...
	public String medicalRecordsDetails(
		...
		ResponseDetailMedicalHistoryDto myMedicalRecordDetail = appointmentService.getMyMedicalRecordDetail(
			appointmentSeq);
	...
	public String myPage(@AuthenticationPrincipal UserDetails principal, Model model) {
		...
		MemberInfoResponseDto memberInfoResponseDto = memberService.getMemberByEmail(username);
	...
	public String getMyReservationList(
		...
		List<ResponseAppointmentDto> responseAppointmentDtos = appointmentService.getAppointmentListByMemberEmail(
			principal.getUsername());
	...
	public String findFavorites(
		...
		List<ResponseFavoritesHospitalDto> responseFavoritesHospitalDtos = memberService.getFavoritesByMemberEmail(
			principal.getUsername());
